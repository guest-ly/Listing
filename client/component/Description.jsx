...
class Description extends React.Component{
    ...
    render(){
        ...
        if(detail){
            ...
            var beds = detail.bednum
        }
        var arrgs= [];
        var bedicon;
        for(var i=1; i<=br; i++){
            // bedoption = bedoptions[Math.floor(Math.random()*bedoptions.length)]
            var bedoption = beds[i-1];
            ...
            <div >
                ...
                <div className={styles.roomarrg}>
                    ...
                    <div className={styles.arrgline}>
                        <div className={styles.btnPre} onClick={e=>this.getpre()}>
                            <span>
                                <button type={"button"}>
                                    <svg viewBox={'0 0 18 18'} role={'presentation'} focusable={'false'}  >
                                        <path d={arrow} ></path>
                        ...
                        <div className={styles.btnNext} onClick={e=>this.getnext()}>
                            <span>
                                <button type={"button"}>
                                    <svg viewBox={'0 0 18 18'} role={'presentation'} focusable={'false'}  >
                                        <path d={arrow} ></path>
